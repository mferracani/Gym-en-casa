...
export const exerciseVisualsById: Record<string, ExerciseVisual> = {
  ...
  "renegade-dumbbell-row": {
    src: "/images/exercises/renegade-dumbbell-row.webp",
    alt: "Inicio en plancha y final del remo renegado con una mancuerna elevada hacia las costillas",
    width: 1536,
    height: 1024,
  },
  "bent-over-double-dumbbell-row": {
    src: "/images/exercises/bent-over-double-dumbbell-row.webp",
    alt: "Inicio y final del remo inclinado bilateral con dos mancuernas",
    width: 1536,
    height: 1024,
  },
  "underhand-bent-over-dumbbell-row": {
    src: "/images/exercises/underhand-bent-over-dumbbell-row.webp",
    alt: "Inicio y final del remo inclinado bilateral con agarre supino",
    width: 1536,
    height: 1024,
  },
  ...
  "underhand-chest-supported-dumbbell-row": {
    src: "/images/exercises/underhand-chest-supported-dumbbell-row.webp",
    alt: "Inicio y final del remo bilateral supino con el pecho apoyado en banco inclinado",
    width: 1536,
    height: 1024,
  },
  "incline-chest-supported-dumbbell-shrug": {
    src: "/images/exercises/incline-chest-supported-dumbbell-shrug.webp",
    alt: "Inicio con hombros bajos y final del encogimiento para trapecio con pecho apoyado",
    width: 1536,
    height: 1024,
  },
  "standing-dumbbell-shrug": {
    src: "/images/exercises/standing-dumbbell-shrug.webp",
    alt: "Inicio con hombros bajos y final del encogimiento de trapecio de pie con mancuernas",
    width: 1536,
    height: 1024,
  },
  ...
  "seated-triple-leg-raise": {
    src: "/images/exercises/seated-triple-leg-raise.webp",
    alt: "Inicio y final de la triple elevación de piernas sentado, con el abdomen resaltado",
    width: 1536,
    height: 1024,
  },
  "lying-windshield-wiper": {
    src: "/images/exercises/lying-windshield-wiper.webp",
    alt: "Piernas juntas hacia ambos lados en el limpiaparabrisas acostado, con los oblicuos resaltados",
    width: 1536,
    height: 1024,
  },
  "floor-crunch": {
    src: "/images/exercises/floor-crunch.webp",
    alt: "Inicio acostado y final del crunch corto en el piso, con el abdomen resaltado",
    width: 1536,
    height: 1024,
  },
  "forearm-plank": {
    src: "/images/exercises/forearm-plank.webp",
    alt: "Vista inicial y lateral de la plancha de antebrazos, con el core resaltado",
    width: 1536,
    height: 1024,
  },
  "lying-leg-raise": {
    src: "/images/exercises/lying-leg-raise.webp",
    alt: "Inicio con piernas bajas y final vertical de la elevación de piernas acostado",
    width: 1536,
    height: 1024,
  },
  "cross-body-crunch": {
    src: "/images/exercises/cross-body-crunch.webp",
    alt: "Inicio acostado y final cruzado acercando hombro y rodilla contrarios",
    width: 1536,
    height: 1024,
  },
  "x-crunch": {
    src: "/images/exercises/x-crunch.webp",
    alt: "Inicio extendido en X y final del crunch acercando manos y pies",
    width: 1536,
    height: 1024,
  },
  "wide-stance-plank": {
    src: "/images/exercises/wide-stance-plank.webp",
    alt: "Dos vistas de la plancha con manos y pies abiertos, con el core resaltado",
    width: 1536,
    height: 1024,
  },
  "twisting-crunch": {
    src: "/images/exercises/twisting-crunch.webp",
    alt: "Inicio acostado y final del crunch con giro hacia una rodilla",
    width: 1536,
    height: 1024,
  },
  "side-plank-hip-dip": {
    src: "/images/exercises/side-plank-hip-dip.webp",
    alt: "Posición baja y alta de la plancha lateral con descenso de cadera",
    width: 1536,
    height: 1024,
  },
